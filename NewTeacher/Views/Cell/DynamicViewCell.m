...
- (void)setImages:(NSArray *)items Rects:(NSArray *)rects Count:(long)reples;
...
#pragma mark - cell
@interface DynamicViewCell()<ResuableButtonDelegate,ColleagueImageViewDelegate,CliassHeaderViewDelegate>
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //header
        _headerView = [[CliassHeaderView alloc]initWithFrame:CGRectMake(0, 10, [UIScreen mainScreen].bounds.size.width - 90, 40)];
        ...
        [_attentionLab setNumberOfLines:0];
...
- (void)resetClassGroupData:(id)object
{
    ...
    if (model.replyBackRect.size.height > 0) {
        [_replyView setImages:model.reply Rects:model.replyRects Count:(long)[model.replies longValue]];
