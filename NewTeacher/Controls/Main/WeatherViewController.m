...
- (void)viewDidLoad {
    ...
    NSDictionary *dic = @{@"class_id":manager.userInfo.classid,@"teacher_id":manager.userInfo.userid,@"mobile":[userDefault objectForKey:LOGIN_ACCOUNT]};
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        //[tipLabel setText:[NSString stringWithFormat:@"派派提醒您：%@",[[NSUserDefaults standardUserDefaults] objectForKey:[WEALTHY_DATA stringByAppendingString:userId]]]];
