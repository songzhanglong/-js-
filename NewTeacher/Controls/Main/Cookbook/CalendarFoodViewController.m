...
@interface CalendarFoodViewController ()<MyCalendarView4Delegate,UITableViewDataSource,UITableViewDelegate>

@end

@implementation CalendarFoodViewController
{
    MyCalendarView4 *_calendarView;
...
//    _headerRefresh = hView;
    ...
    //日历
    MyCalendarView4 *calendar = [[MyCalendarView4 alloc] initWithFrame:CGRectZero];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell resetClassCookbookData1:item isHidden:NO];
