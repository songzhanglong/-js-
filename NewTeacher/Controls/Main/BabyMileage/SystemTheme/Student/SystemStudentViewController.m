...
@interface SystemStudentViewController ()

@end

@implementation SystemStudentViewController
...
- (void)requestFinish:(BOOL)success Data:(id)result
{
    ...
    if ([self.dataSource count] == 0) {
        SystemStudent2ViewController *class2 = [[SystemStudent2ViewController alloc] init];
