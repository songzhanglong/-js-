...
- (void)viewDidLoad {
    ...
    NSString *param = [NSString stringWithFormat:@"userid=%@&is_teacher=1&from=2&datafrom=1&mid=0",[DJTGlobalManager shareInstance].userInfo.userid];
