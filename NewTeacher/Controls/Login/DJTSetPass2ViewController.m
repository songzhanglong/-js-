...
- (void)viewDidLoad {
    ...
    [str addAttribute:NSForegroundColorAttributeName value:CreateColor(3, 210, 126) range:range];
    ...
    [button setBackgroundImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"d12" ofType:@"png"]] forState:UIControlStateNormal];
    [button setBackgroundImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"d12_1" ofType:@"png"]] forState:UIControlStateHighlighted];
    [button setTitleColor:CreateColor(3, 111, 67) forState:UIControlStateNormal];
...
- (void)beginGetVelifyCode:(NSString *)mobile
{
    ...
    [dic setObject:@"1" forKey:@"is_teacher"];
